    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:block relative flex-1">
        <img
          ...
          src="https://images.pexels.com/photos/4226122/pexels-photo-4226122.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop"
          alt="Healthcare technology"
        />
        <div className="absolute inset-0 bg-primary-600 bg-opacity-75"></div>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-8">
            <h3 className="text-3xl font-bold mb-4">Join Our Healthcare Revolution</h3>
            <p className="text-xl text-primary-100">
              Experience the future of healthcare with AI-powered diagnostics and personalized care
            </p>
          </div>
        </div>
      </div>
